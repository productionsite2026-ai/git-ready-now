...
export const HowItWorksSection = () => {
  const steps = [
    ...
    },
    {
      ...
      icon: Calendar,
      title: "Réservez",
      description: "Déposez une annonce spécifique ou choisissez le service, la date et l’heure. Votre paiement est sécurisé par séquestre et bloqué jusqu’à votre validation lors du retour de votre animal.",
