...
const homeFAQs = [
  ...
  },
  {
    ...
    answer: "Absolument. Chaque Accompagnateur passe par un processus de sélection rigoureux, avec une vérification manuelle de chaque profil par notre équipe. Cela inclut la validation des informations personnelles, de la pièce d’identité (CNI), du  et des formations. Seuls 35% des candidats sont acceptés. Vous pouvez confier votre compagnon en toute sérénité."
  },
  {
