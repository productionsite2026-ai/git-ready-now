...
## 5. Administration et Gouvernance (admin.dogwalking.fr)

L'interface d'administration permet une gestion centralisée et sécurisée de la plateforme. Elle se concentre sur deux axes majeurs : la modération et la performance.

Les administrateurs ont la charge de la **vérification manuelle des documents** soumis par les futurs Accompagnateurs (CNI, Casier B2, Formations). Ce contrôle humain est le garant du respect du taux d'acceptation de **35%**. L'interface offre également une vue consolidée sur la santé financière de la plateforme (Chiffre d'Affaires, commissions de 15%, volume de missions terminées). En cas de contestation ou d'incident signalé via l'outil "GO", les administrateurs disposent d'un module de médiation pour analyser les preuves visuelles et trancher les litiges équitablement.
